...
Pathname.glob("spec/shared_contexts/*.rb") do |file|
  require file.relative_path_from(Pathname.new('spec'))
end

Pathname.glob("spec/shared_behaviours/**/*.rb") do |behaviour|
  require behaviour.relative_path_from(Pathname.new('spec'))
end
